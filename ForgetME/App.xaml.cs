...
namespace ForgetME
{
    public partial class App : Application
    {
        ...
        private void Application_Launching(object sender, LaunchingEventArgs e)
        {
            ...
            if (sett.PasswordSetting.Equals("", StringComparison.CurrentCulture))
            {
                // check whether a key exists and then start.
                //(Application.Current.RootVisual as PhoneApplicationFrame).Navigate(new Uri("/Assets/SettingsExt.xaml", UriKind.RelativeOrAbsolute));
                sett.FirstUse = true;
            }
        ...
        {
            // on evry activation of the app the login page is shown
